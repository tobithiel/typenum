...
use {Cmp, Equal, Gcd, Greater, IsGreaterOrEqual, Len, Less, NonZero, Ord, Pow, SquareRoot};
...
use consts::{U0, U1};
use {Add1, Double, Gcf, GrEq, Length, Minimum, Maximum, Or, Prod, Shleft, Shright, Sqrt, Square, Sub1, Sum};
